...
const SbtJoin: React.FC = () => {
  return (
    <div id="sbt-join" className="w-full h-full flex flex-col items-center justify-center text-center p-8 bg-adam-black relative">
         <div className="absolute inset-0 z-0 bg-adam-dark">
            <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-sbt-teal-dark/20 rounded-full blur-3xl animate-pulse -translate-x-1/2 -translate-y-1/2"></div>
        </div>
      ...
      <div className="relative z-10">
        ...
        <p className="mt-4 text-adam-light-gray font-light max-w-xl mx-auto">
          Your on-chain identity is earned, not bought. Engage with the community, contribute your expertise, and forge your reputation within The Arc.
        </p>
        <div className="mt-10">
            <a href="#" className="border border-sbt-teal text-sbt-teal font-light py-4 px-12 rounded-sm text-md uppercase tracking-[0.2em] hover:bg-sbt-teal hover:text-black hover:shadow-glow-teal transition-all duration-300">
                Join The Community
            </a>
        </div>
      </div>
       <footer className="absolute bottom-8 text-center text-xs text-gray-700 font-light tracking-widest w-full">
         <div className="flex justify-center space-x-6 mb-4">
          <a href="#" className="text-gray-600 hover:text-sbt-teal transition-colors duration-300" aria-label="ARCx Twitter">
            <span className="sr-only">Twitter</span>
            <TwitterIcon className="h-5 w-5" />
          </a>
          <a href="#" className="text-gray-600 hover:text-sbt-teal transition-colors duration-300" aria-label="ARCx Discord">
